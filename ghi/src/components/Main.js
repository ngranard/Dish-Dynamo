  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Never struggle again with what to eat!
            </Text>
            <Spacer />
            <Text
              p={{ base: "5px", md: "10px" }}
              ...
              fontSize={{ base: "lg", md: "3xl" }}
            >
              Dish Dynamo is an app
              that allows you to search for and create recipes based on the ingredients you
              have on hand.
            </Text>
      ...
      >
        ...
        <VStack columns={{ base: 1, md: 2 }} spacing={4} w="auto">
          <motion.div
            ref={ref1}
            initial={{ x: "100%" }}
            animate={{ x: inView1 ? 1 : "10%" }}
