...
function UserRecipes() {
    ...
    const confettiBackground = useColorModeValue(CONFETTI_LIGHT, CONFETTI_DARK);
    ...
    return (
        <Flex css={{
            backgroundImage: confettiBackground,
            backgroundAttachment: "fixed",
        }}>
            <Box maxW="600px" mx="auto" >
                <Box fontSize="3xl" fontWeight="bold" textAlign="center" my={8}>
                    {user.first_name && user.last_name ? `${user.first_name}'s Recipes` : "Your Recipes"}
                </Box>
                {recipes.length > 0 ? (
                    recipes.map((recipe) => (
