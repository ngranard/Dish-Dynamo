...
import { Icon as Icon1 } from "@chakra-ui/react";
...
export default function AboutPage() {
  ...
  const developers: Developer[] = [
    ...
    },
    {
      ...
      githubUrl: "https://github.com/sfsmuse",
    },
    {
      name: "Tenzing",
      role: "Fullstack Engineer",
    ...
    <>
      ...
      >
        ...
        <Container maxW="container.lg">
          ...
          >
            <Text fontSize="lg">
              Dish Dynamo is an app that helps users figure out what to eat and
              share their favorite recipes. Developed by a talented team of
              engineers, the app aims to revolutionize the way people think
              about cooking.
            </Text>
          </Box>
        </Container>
        ...
        <Box>
          <Center>
            ...
            >
              ...
              >
                <Icon1 as={FaReact} boxSize={20} />
              </IconContainer>
              <IconContainer
                whileHover={{ scale: 1.2 }}
                transition={{ duration: 0.2 }}
              >
                <Icon1 as={FaJsSquare} boxSize={20} />
              </IconContainer>
              <IconContainer
                whileHover={{ scale: 1.2 }}
                transition={{ duration: 0.2 }}
              >
                <Icon icon="simple-icons:typescript" width="70" height="70" />
              </IconContainer>
              <IconContainer
                whileHover={{ scale: 1.2 }}
                transition={{ duration: 0.2 }}
              >
                <Icon1 as={FaPython} boxSize={20} />
              </IconContainer>
              <IconContainer
                whileHover={{ scale: 1.2 }}
                transition={{ duration: 0.2 }}
              >
                <Icon icon="simple-icons:fastapi" width="80" height="80" />
              </IconContainer>
              <IconContainer
                whileHover={{ scale: 1.2 }}
                transition={{ duration: 0.2 }}
              >
                <Icon icon="simple-icons:postgresql" width="80" height="80" />
              </IconContainer>
              <IconContainer
                whileHover={{ scale: 1.2 }}
                transition={{ duration: 0.2 }}
              >
                <Icon1 as={FaDocker} boxSize={20} />
              </IconContainer>
              <IconContainer
                whileHover={{ scale: 1.2 }}
                transition={{ duration: 0.2 }}
              >
                <Icon1 as={FaGitlab} boxSize={20} />
              </IconContainer>
            </HStack>
          </Center>
        </Box>
